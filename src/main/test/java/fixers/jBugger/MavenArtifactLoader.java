...
public class MavenArtifactLoader {
    ...
    public static File resolve(String groupId, String artifactId)
    {
        ...
        String path = new MavenArtifactLoader(groupId.trim(), artifactId.trim(), System.getProperty("java.class.path"), File.pathSeparatorChar, File.separatorChar).resolve();
        if (path == null)
        {
    ...
    MavenArtifactLoader(String groupId, String artifactId, String classPath, char pathSeparator, char fileSeparator)
    {
